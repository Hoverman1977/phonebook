...
if (isset($_POST['login'])) {
        $security->login($_POST['username'], $_POST['password']); // call the login method
}
...
?>
            ...
            <p>Please enter your username and password.</p>
					...
					<form id="login" action="/login.php" method="post">
                                ...
                                <p>If you do not have a username and password, you need to request one by contacting ICT Service Hub</p>
